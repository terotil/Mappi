...
function Epoch(name,mode,targetelement,multiselect)
{
	...
	if(this.mode == 'popup' && targetelement && targetelement.type == 'text') //if the target element has been set to be an input text box
	{
		...
		this.tgt.onkeypress = function () {this.calendar.hide();};
	}
	else
	{
...
{
	this.daylist = new Array('Su','Ma','Ti','Ke','To','Pe','La','Su','Ma','Ti','Ke','To','Pe','La'); /*<lang:en>*/
	this.months_sh = new Array('Tammi','Helmi','Maalis','Huhti','Touko','Kes‰','Hein‰','Elo','Syys','Loka','Marras','Joulu');
	this.monthup_title = 'Seuraava kuukausi';
	this.monthdn_title = 'Edellinen kuukausi';
	this.clearbtn_caption = 'Tyhjenn‰';
	this.clearbtn_title = 'Tyhjent‰‰ valinnat kalenterista';
...
Date.prototype.dateFormat = function(format)
{
	...
	var MONTH_NAMES = new Array('Tammikuu','Helmikuu','Maaliskuu','Huhtikuu','Toukokuu','Kes‰kuu','Hein‰kuu','Elokuu','Syyskuu','Lokakuu','Marraskuu','Joulukuu','Tammi','Helmi','Maalis','Huhti','Touko','Kes‰','Hein‰','Elo','Syys','Loka','Marras','Joulu');
	var DAY_NAMES = new Array('Sunnuntai','Maanantai','Tiistai','Keskiviikko','Torstai','Perjantai','Lauantai','Su','Ma','Ti','Ke','To','Pe','La');
	format = format + "";
	var result="";
	var i_format=0;
	var c="";
